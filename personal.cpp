...
void wishme(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning my liege"<<endl;
        string phrase = "Good Morning my liege";
        ...
        cout<< "Good Afternoon my liege"<<endl;
        string phrase = "Good Afternoon my liege";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening my liege"<<endl;
        string phrase = "Good Evening my liege";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    do
    {
        ...
        if(strcmp(password, "DSxTanjiro")==0){
            cout<<"\n<==================================================================================================>\n\n";
            wishme();
            do{
                cout<<"\n<==================================================================================================>\n\n";
                cout<<endl<<"How can i help you my liege...."<<endl<<endl;

                string phrase = "How can i help you my liege";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                if(strcmp(ch, "hi") == 0 || strcmp(ch, "hey") == 0 || strcmp(ch, "hello") == 0 ){
                    cout<<"Hello my liege....."<<endl;
                    string phrase = "Hello my liege";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
